          ...
          <form #regForm="ngForm" (ngSubmit)="regForm.valid && onRegister()" class="auth-form">
            ...
            <div class="form-group">
              ...
              <div class="password-input-wrapper">
                <input id="password" [type]="showPassword ? 'text' : 'password'" class="form-control" [(ngModel)]="password" name="password" placeholder="Min 6 characters" required minlength="6" />
...
export class RegisterComponent {
  fullName = ''; email = ''; password = ''; phone = ''; role = 'CUSTOMER'; loading = false; showPassword = false;
